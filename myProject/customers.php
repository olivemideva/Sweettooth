...
<html lang="en">
  ...
  <body>
    ...
    $result =$conn->query("SELECT * FROM users")  or die ("<script>alert('Data selection failed!!')</script>");
    ...
    <div class="row justify-content-center">
        <table class="table table-fluid" id="myTable">
            ...
            <tr>
                ...
                <td>
                    <a href="customers.php?edit=<?php echo $rows['id']?>"
                    class = "btn btn-info">Edit</a>
                    <a href="adminprocess.php?delete=<?php echo $rows['id']?>"
